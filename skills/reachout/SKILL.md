...
**The body arrives finished.** Greeting, the specific line, the provenance sentence and the question are all composed before the composer is opened, bidi marks stripped. **If the operator is typing "שלום דנה" into a composer, something upstream failed** — stop and fix that rather than helping them type.
